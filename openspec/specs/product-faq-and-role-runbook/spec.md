# product-faq-and-role-runbook Specification

## Purpose
Определяет навигационный русскоязычный FAQ и ролевые runbooks как
пользовательский, но не нормативный слой над каноническими OpenSpec-контрактами.
## Requirements
