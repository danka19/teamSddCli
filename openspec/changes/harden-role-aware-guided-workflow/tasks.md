...
- [x] Run focused/final relevant tests, OpenSpec/roadmap gates, AI-disabled request walkthrough, and final security review; prepare the exact final human acceptance packet.
