...
Status: work items 2.1-2.3 are closed. Work item 2.4 is active and consumes the static schema-v2 and policy/config foundation for deterministic classification and bounded legacy migration.
