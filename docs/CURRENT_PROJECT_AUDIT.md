...
- Status: accepted intake and delivery boundary; detailed design review remains required before OpenSpec artifacts and implementation planning are created.
