...
| AUDIT-010 | The generated Confluence publication model is planned, and the 2026-07-09 decision accepts analyst/change-owner triage, blocker/non-blocker comment handling, explicit dispositions, generated source warnings, and evidence-backed status display. Publication automation still remains outside the first MVP and blocked until a later implementation plan decides generated views and tooling. | Phase 1/4 | open |
...
| 2026-07-09 | Existing Confluence analytics corpus is a read-only archive for the first pilot; no bulk migration is required. | Reused legacy material must become new Git/OpenSpec source through a reviewed change instead of being edited in Confluence as canonical source. |
...
| 2026-07-09 | Confluence feedback uses analyst/change-owner triage, explicit dispositions, and blocker/non-blocker behavior. | Later Confluence-enabled publication/archive is blocked by unresolved blocker comments; non-blockers may continue only with accepted/rejected/deferred/duplicate disposition. |
