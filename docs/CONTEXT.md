...
- The corporate environment must not become the primary development surface for reusable process behavior: Phase 2 produces the externally accepted transfer-ready release candidate, and Phase 3 performs only verified adaptation and a monitored pilot.
