...
> Phase 1 has produced the first accepted OpenSpec baseline. Phase 2 is pending human acceptance: work items 2.1-2.13 and technical gates 2.14.1-2.14.3 are closed, while 2.14.4 is the explicit human-owner gate. Immutable candidate `phase-2-14-rc6` packages release-integrity remediation at `295 covered / 7 gaps / 32 future_work`; its payload SHA-256 is `172707ba159e1e060561d6d02ad67dcaf2fa4ce64a58c23bd9c55613713fd951` and manifest SHA-256 is `0c7670637f1f59f82a6cae3bea48c53edfa3453d5fcf0c599bf013bd301c3146`. Fresh AI-disabled, Qwen/DeepSeek, Windows/WSL2, rollback, privacy, exact-raw-closure, and independent review evidence is complete with no diagnostics. `D-019` confirms that seven explicit P3/P4 integration gaps do not block this first-MVP boundary. Technical `READY` and `evidence-complete` do not constitute human acceptance; no corporate configuration or pilot may start before that decision. Historical rc4 remains unchanged, and rc5 is retained as diagnostic rejected history after its raw inventory included an undeclared probe. macOS is not certified.
