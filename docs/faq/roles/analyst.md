...
Для сырой идеи начните с
[режима `analyst-discovery`](../ai-collaboration.md#режим-analyst-discovery-от-сырой-идеи-к-черновику):

```text
Роль человека: Analyst.
Помоги разобраться и оформить новую идею. Сначала покажи темы интервью, затем
после моего разрешения задавай по одному вопросу.
```

Analyst подтверждает смысл итоговой сводки и назначает владельцев открытых
решений. AI помогает сформулировать черновик, но его `proposed` wording не
становится `confirmed` фактом без человека или canonical source.
