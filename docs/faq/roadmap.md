...
- получить role-aware route для новых ситуаций и real schema-v2 change через
  `sdd next`, который читает канонический `status`;
...
по этим страницам установить package, пройти real-package route и правильно
назвать authority boundaries. Для acceptance всё ещё требуется независимый
first-time user walkthrough; только после него human может принять successor
reusable package для controlled corporate adaptation.
