...
**Статус и граница.** FAQ принят владельцем процесса после закрытия human
walkthrough gate 4.4. Sync Delta Specs и archive change остаются отдельными
человеческими lifecycle-решениями.
