...
**Статус и граница.** FAQ принят владельцем процесса; Delta Specs
синхронизированы, а change архивирован 2026-07-24. Дальнейшие изменения FAQ
вносятся через новый OpenSpec change.
