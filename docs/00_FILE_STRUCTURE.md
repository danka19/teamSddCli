...
| `docs/planning/REPO_TOPOLOGY_EVALUATION_CRITERIA_2026-07-09.md` | Evaluation criteria for the internal OpenSpec customization screenshots and the central-repo vs specs-next-to-code comparison frame for work item 1.4 |
