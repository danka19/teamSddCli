...
| `docs/superpowers/plans/2026-07-24-central-team-specs-ai-role-workflow-faq.md` | Подробный TDD/OpenSpec-план FAQ для central team-specs, multi-repository setup, Analyst/Developer/QA zero-start и ограниченных AI permissions |
