...
| `openspec/changes/close-release-integrity-gaps/` | Apply-ready Phase 2 change for deterministic Delta operation semantics, human-authorized dated archive convention, and reviewed process-package/OpenSpec upgrade evidence before successor-candidate freeze |
