...
Work items 2.1-2.9 are closed after all required gates; work item 2.10 is ready and has not started.
...
- Technical prerequisites and planning acceptance are complete. Work items 2.1-2.9 are closed; work item 2.10 is ready and has not started.
...
No current design or planning decision blocks work item 2.10, but it has not started.
