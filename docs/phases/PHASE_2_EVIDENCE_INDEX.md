...
- Coverage is 334 effective scenarios: 204 covered, 110 explicit missing-evidence rows routed in immutable rc4 to human acceptance, and 20 later-work scenarios. Gaps remain visible and are not represented as passing evidence. The 2026-07-19 provenance audit shows that their identical `medium` metadata is a mechanical fallback, then accounts for all rows as 75 Phase 2 exact-evidence debt, 22 governance/manual evidence, 2 Phase 3 corporate evidence, 10 Phase 4 publication evidence, and 1 Phase 2 scope-boundary record.
