...
- Current roadmap focus: work item 2.9 is closed; work item 2.10 is the next ready sequential step and has not started.
...
Work items 2.1-2.9 are closed; work item 2.10 is ready and has not started.
