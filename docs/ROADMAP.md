...
- Current roadmap focus: work item 2.11 is in progress; the AI-disabled baseline passed, the honest non-leading Qwen-family proxy has explicit failures/fallbacks, and mandatory DeepSeek-family certification remains.
...
Work items 2.1-2.10 are closed; work item 2.11 is in progress after a passing AI-disabled baseline and a partially failing Qwen-family proxy run, and still awaits DeepSeek-family certification plus later acceptance of explicit fallback dispositions.
