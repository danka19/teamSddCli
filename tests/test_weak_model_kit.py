...
SCENARIO_COVERAGE = {"test_build_read_pack_is_authority_labelled_bounded_and_stable":[{"source_kind":"accepted","capability":"repo-topology-config","requirement":"Practical developer and agent workflow","scenario":"Developer receives a bounded read pack"},{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Bounded authority-labelled read packs","scenario":"Read pack identifies source authority"},{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Bounded authority-labelled read packs","scenario":"Read pack stays task specific"}],"test_launcher_selects_instruction_and_stop_point_outside_model":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Deterministic workflow launch","scenario":"User starts a bounded role operation"},{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Deterministic workflow launch","scenario":"Model does not select its own authority"}],"test_operation_evidence_accepts_supported_advisory_completion":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"AI remains advisory and non-authoritative","scenario":"Model draft becomes evidence only after review"},{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Evidence-backed weak-model output","scenario":"Completion output includes evidence boundaries"}],"test_role_instructions_are_bounded_and_reference_canonical_contract":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Role instructions and explicit stop points","scenario":"Negative examples prevent common overreach"}],"test_parallel_plan_allows_only_independent_scopes_with_complete_gates":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Safe parallel AI execution","scenario":"Independent tasks run concurrently"}],"test_parallel_plan_serializes_or_blocks_unsafe_work":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Safe parallel AI execution","scenario":"Shared mutation prevents unsafe parallelism"}],"test_parallel_promotion_requires_each_focused_and_combined_pass_evidence":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Safe parallel AI execution","scenario":"Parallel outputs pass an integration gate"}],"test_operation_evidence_rejects_derived_canonical_artifact_without_source_reference":[{"source_kind":"delta","capability":"weak-model-guardrails","requirement":"Weak-model artifacts preserve source ownership","scenario":"Derived instruction references canonical contracts"}]}
